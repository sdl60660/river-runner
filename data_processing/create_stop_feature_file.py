...
# Extract the 2500 largest named lakes
...
sorted_features = sorted_features[:2500]
...
# Output as a GeoJSON file for now (~5MB), but then use mapshaper.org to compress to a TopoJSON (~1.5MB)
