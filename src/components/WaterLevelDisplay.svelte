    ...
    onMount(async () => {
        ...
        class Caustics {
            constructor(lightFrontGeometry) {
                ...
                this.loaded = Promise.all(shadersPromises).then(
                    ([vertexShader, fragmentShader]) => {
                        ...
                        this._causticMesh = new THREE.Mesh(
                            this._geometry,
                            material
                        );
                    }
            ...
            update(renderer, waterTexture) {
                this._causticMesh.material.uniforms["water"].value =
                    waterTexture;
        ...
        class Walls {
            constructor() {
                ...
                this.back.geometry.vertices.forEach((d) => {
                    d.z = -1.02;
                });
                ...
                this.left.geometry.vertices.forEach((d) => {
                    d.x = -1.02;
                });
                ...
                this.right.geometry.vertices.forEach((d) => {
                    d.x = 1.02;
                });
                ...
                this.bottom.geometry.vertices.forEach((d) => {
                    d.y = -1.02;
                });
        ...
        class Water {
            ...
            adjustYPositionVertices(yPosition) {
                this.mesh.geometry.vertices.forEach((d) => {
                    d.z = yPosition;
                });
                this.mesh.geometry.verticesNeedUpdate = true;
            }
        ...
        class Pool {
            ...
            setHeight(targetHeight) {
                ...
                this._geometry.vertices.forEach((d) => {
                    d.y += (2 - targetHeight) / 2;
                });
        ...
        const animate = () => {
            ...
            water.adjustYPositionVertices(
                currentFlowrate.level / (maxFlowrate / 2) - 1
            );
            pool.setHeight(4 * (currentFlowrate.level / maxFlowrate));
